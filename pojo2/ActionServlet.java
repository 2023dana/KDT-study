		...
		if(result !=null) {
			...
			if(pageMove !=null) {
				...
				if("redirect".equals(pageMove[0])) {
					//forward 처리시와 동일한 컨벤션을 적용하기 위해서 접두어와 접미어를 붙이는 과정에서 오류가 발동
					//현재 구조상 입력|수정|삭제 모두 처리 성공시 목록페이지로 응답이 나가도록 설계가 되어있다는 것을 간과함
